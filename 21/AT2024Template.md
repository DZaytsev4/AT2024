...
- **Интерфейсы пользователя**:
   ...
   - Интерфейс для просмотра и управления статусами предметов (добавление, редактирование, списание, перемещение, разукомплектование и укомплектование).
...
- Списание предметов при достижении нулевой стоимости по результатам голосования комиссии, где все члены должны согласиться со списанием.
